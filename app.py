...
def summarize_stage_1(chunks_text):
  ...
  st.write('Stage 1:', str(round(end-start,2)), "seconds")
...
def summarize_stage_2(stage_1_outputs, topics, summary_num_words = 250):
  ...
  st.write('Stage 2:', str(round(end-start,2)), "seconds")
...
txt = st.text_area("**Longsnapper** Beta is your AI-powered reading assistant for longform text. Enter the longform text to summarise below:")
...
if st.button('Let\'s Go!'):
  ...
  for output in stage_2_outputs:
    title_text = output['title']
    title_summ = output['summary']
    st.write("*" + title_text + "*")
    st.write(title_summ)
  st.write("*Summary*")
